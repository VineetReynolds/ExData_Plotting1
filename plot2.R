...
# read from the household energy consumption datafile, and save it in a PNG
# file named plot2.png
plot2 <- function() {
  # Load data from the dataset file for exploratory analysis
  powerConsumption <- loadPowerConsumptionData()
  
  # Draw the plot on a PNG file named plot2.png in the current working dir,
  # with width and height of 480 px, and a white background.
  png(filename = "plot2.png", width = 480, height = 480, bg = "white")
  
  # Plot a line graph of the Global active power vs time.
  # Set the label for y-axis.
  with(powerConsumption, plot(Global_active_power ~ DateTime, type = "l", ylab= "Global Active Power (kilowatts)", xlab=""))
